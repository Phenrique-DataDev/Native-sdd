...
function Format-SkillScaffold {
    ...
    .SYNOPSIS
        ...
        + seções TODO. Compatível com o I1 (ConvertFrom-SkillFrontmatter/Get-SkillHealth → valid +
    ...
    [void]$sb.Append("TODO: descrever os gatilhos de uso desta skill.`n`n")
    [void]$sb.Append("## Capacidade`n")
    [void]$sb.Append("$cap`n`n")
    [void]$sb.Append("## Passos`n")
    [void]$sb.Append("TODO: passos/checklist que a skill executa.`n`n")
    [void]$sb.Append("## Notas`n")
    [void]$sb.Append("TODO: armadilhas, limites, referências.`n")
    return $sb.ToString()
}
