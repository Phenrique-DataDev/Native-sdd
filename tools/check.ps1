...
function Get-LintPlan {
    ...
    @(
        ...
        @{ Name = 'resync-lint'; Tool = 'resync-lint.ps1'
            # Staleness dos artefatos DERIVADOS (AGENT_MAP/graph/kb-index) do scaffold vs estado ao vivo.
            # Backstop do caminho manual; o primário é o resync na criação (Invoke-Resync -Write).
