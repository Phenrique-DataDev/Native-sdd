# Metodologia de IA · AI Methodology
...
│   ├── windows/            impl. real: apply, install-clis, install-mcp (context7), lib.ps1 (puras)
...
│   ├── agent-lint · kb-lint · config-lint    contratos de agente / KB / settings.json
│   ├── doc-lint · doubt-lint · standards-lint · hooks-lint   contratos de docs / rules / hooks
│   ├── init · audit-agents(*) · sync-context · adapt   curadoria e brownfield
│   ├── update-skills · skill-gap             higiene e geração de skills
│   ├── orchestrate · reflect · telemetry     protocolo do líder · consolidação da KB · telemetria
