...
```powershell
# Windows (PowerShell 5.1+) — sem clonar
...
**Levar melhorias do framework a um projeto já criado** (o scaffold é copiado, não linkado):

```powershell
nsp <caminho-do-projeto> -Update -DryRun   # mostra o plano, sem escrever
