...
# A fórmula `powershell` do brew TEM bottle no arm64 (7.6.6, conferido na API do Homebrew em
# 2026-09-11), mas não no Intel, e puxa `dotnet`: trocar custaria dois caminhos. Fica o tarball, que
# serve aos dois (PWSH_VIA_BREW_NO_ARM64, gate 3/5 — o "compila do fonte" daqui estava desatualizado).
ensure_pwsh() {
