#!/usr/bin/env bash
# bootstrap.sh — bootstrap remoto do Native-SDD (Linux e macOS): baixa `main` do espelho público e delega
...
suggest_install() {
    # macOS traz curl e tar (bsdtar, que aceita --strip-components) de fábrica; o brew é só a dica.
