...
.PARAMETER Profile
  ...
  mvp   Enxuto, para protótipo/MVP: entrega só as rules do NÚCLEO (workflow-sdd, project-context,
        cli-first, tooling) e NÃO instala os 4 hooks de processo do projeto (curation-nudge,
        peer-heartbeat, agent-graph-context, complementary-repo-guard). Economia medida: ~45k chars
