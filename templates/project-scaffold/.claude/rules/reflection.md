...
A KB só **cresce** (`/train-kb` adiciona; nada consolida). Em projetos maiores ela acumula o **mesmo
conceito em 2 entradas**, **prosa verbosa** e **conhecimento superado** — o que incha o contexto e
dilui o sinal. O `/reflect` faz uma passada de **consolidação** que encolhe o inchaço **sem perder o
que importa**: regras implementadas e casos ocorridos. O que decide *o que* consolidar é julgamento
(LLM); o que torna isso seguro é o protocolo abaixo + a verificação `id-provenance`.
