...
DECIDIR** — para decidir por **resultados esperados**, não por fé. O julgamento (se o fix funciona) é
do LLM/ferramenta de domínio; o protocolo + a conformidade do relatório (`tools/simulate.ps1`) tornam
isso seguro e verificável.
