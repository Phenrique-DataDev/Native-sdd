...
> **por fora** (`docs/`) — sem o humano ter que "escolher onde entra o quê". A KB segue a disciplina dela
> (curada, agente-facing, enxuta); este é o **resíduo documentável**, humano×LLM.
>
> A postura é **proativa por julgamento** — disciplina aqui descrita, **não** um motor que regenera docs
> em standing (isso seria doc-rot). O subagent dedicado é `documenter`; o gatilho explícito em lote é
> `/document`.
