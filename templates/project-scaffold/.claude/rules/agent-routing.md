...
| `git-workflow` | vcs | Higiene de repo e o fluxo em volta do PR: conventional commits, branches, `.gitignore`, worktree, **CI vermelho** (localiza o job/step falho — causa-raiz é do `debugger`) e **board** (GitHub Projects: item, campo, ligação issue↔PR) | roda git/gh |
