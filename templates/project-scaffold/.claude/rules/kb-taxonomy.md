...
> **Por que o contrato de escrita saiu daqui:** ele custava ~1 600 tokens em **toda** sessão para
> valer nas poucas em que alguém grava uma entrada. Nada foi removido — foi movido para onde é lido
> por quem escreve.
