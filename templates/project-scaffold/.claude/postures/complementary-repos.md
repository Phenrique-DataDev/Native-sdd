# Repositórios complementares — disciplina completa (sob demanda)

> **Carregada sob demanda**, não always-on. A rule [`../rules/complementary-repos.md`](../rules/complementary-repos.md)
> guarda o **predicado** (o registro existe?) e manda ler este arquivo antes de consultar um repo
> complementar. Custo numa sessão que não consulta nenhum: **0 token**.
