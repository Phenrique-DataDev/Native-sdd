...
- **Mapa de cobertura primeiro** — havendo `BUILD_REPORT` da feature em `.claude/sdd/reports/`, leia a seção `## Não exercitado` **antes** de escolher onde olhar e comece por ali: é onde estavam **todos** os defeitos que a revisão comprou nas rodadas 5 e 6 do baseline. Declarar não isenta.
