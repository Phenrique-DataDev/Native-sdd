...
### O canvas não é rota sua — devolva o briefing

**Você não consegue produzir um canvas** (medido neste scaffold): o harness **descarta** `Artifact` do
allowlist de subagente — declarar em `tools:` não entrega a ferramenta, e sem ela não há canvas publicado.
