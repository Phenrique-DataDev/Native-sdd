...
5. **Reindexar:** rode `/sync-context` para regenerar `docs/_index.md` e o ponteiro — é o catálogo
   que a busca por significado lê (ver [`semantic-search.md`](../rules/semantic-search.md)).
