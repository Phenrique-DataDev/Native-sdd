...
> **`agent-routing-advanced.md` é leitura sob demanda, no Passo 3** — quando você for **agir como
> hub ou orquestrar**, e não antes: são ~11.200 tokens de postura, e o grafo só serve quando há
> encadeamento de experts. A
