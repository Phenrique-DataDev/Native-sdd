...
detalhe · veredito). A seção **link** diz também quantos `.md` varreu (`link : ok (82 arquivos)`):
confira que o número bate com o projeto — um `ok` sobre poucos arquivos não aprova o resto.
