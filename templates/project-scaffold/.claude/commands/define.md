...
## Gate
**Clarity Score mínimo: 12/15.** **Abaixo disso o instrumento é obrigatório**, não uma sugestão:
carregue a skill [`grill-me`](../skills/grill-me/SKILL.md) (tool `Skill`) e feche as lacunas em
rodadas — cada dimensão pontuada abaixo de 3 é um ramo da árvore. Recalcule o score depois da
sessão e registre o valor final no DEFINE. Não vá para o DESIGN com requisitos vagos.

> *"Liste as lacunas e peça esclarecimento"* era o que se fazia enquanto o gate não tinha
> ferramenta: nomear a lacuna não a fecha, e a pergunta solta devolve a ambiguidade em outra forma.
...
- Avançar para `/spec` com Clarity Score abaixo de 12/15.
...
**Próximo passo:** `/spec .claude/sdd/features/DEFINE_<FEATURE>.md`
