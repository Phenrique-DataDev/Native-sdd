...
- `id` único por domínio preservado; entradas seguem o frontmatter do contrato de escrita
  [`postures/kb-writing.md`](../postures/kb-writing.md) — **leia-o** antes de gravar.
