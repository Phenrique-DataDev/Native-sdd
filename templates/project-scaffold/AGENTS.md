...
- Catálogo genérico em [`.claude/agents/`](.claude/agents/): `code-reviewer`, `explorer`,
  `test-writer`. Mapa de relações em [`.claude/agents/AGENT_MAP.md`](.claude/agents/AGENT_MAP.md).
- Roteamento e gatilhos em [`.claude/rules/agent-routing.md`](.claude/rules/agent-routing.md).
