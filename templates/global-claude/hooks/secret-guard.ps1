...
.DESCRIPTION
    Irmao do main-push-guard. Em cada tool Bash decide:
    ...
    Fail-safe ASSIMÉTRICO (igual ao push-guard): antes de confirmar que o comando é relevante,
    ...
    via context7 (/websites/code_claude, 2026-06-07): igual ao main-push-guard.
